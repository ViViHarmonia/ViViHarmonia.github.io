<template>
            ...
            <template v-slot:body-cell-state="props">
              <q-td :props="props">
                <q-select
                  ...
                  :options="props.row.states"
                  fill-input
                  input-debounce="0"
                  dark
                  outlined
                  dense
                  v-if="props.row.states.length > 1"
                ></q-select>
  ...
  <q-dialog
    v-model="museDialog"
    @keyup.left="museSwitch(1)"
    @keyup.right="museSwitch(2)"
    @keyup.down="slideKeyboard(2)"
    @keyup.up="slideKeyboard(1)"
    @keyup.x="museDialog = false"
  >
    <q-card id="muse">
          ...
          <div class="col-xs-12">
            <div class="row justify-center q-pa-xs">
              <q-btn-group class="button">
                <q-btn
                  class="button"
                  @click="museDataCheck = 1"
                  :disabled="museDataCheck == 1"
                  label="Data"
                />
                <q-btn
                  class="button"
                  @click="museDataCheck = 2"
                  :disabled="museDataCheck == 2"
                  label="Desc."
                />
            ...
            <div v-if="museDataCheck == 1">
              ...
              <div
                class="row text-body2 q-pa-xs justify-start"
                v-show="nsfwSwitch"
              >
                <div class="col-sm-12 col-md-2"><b>Dom/Sub:</b></div>
                <div class="col-sm-12 col-md-10">
                  {{ muse.SubDom }}<span class="secret"
                    >{{ muse.SubDomSh }}</span
                  >
                </div>
              </div>
            ...
            <div v-if="museDataCheck == 2">
              <div class="row q-pa-sm justify-start">
                <div class="row text-body2 q-pa-xs justify-start">
                  ...
                  <div class="col-sm-12 col-md-10">
                    {{ muse.Desc }}<span class="secret" v-show="nsfwSwitch"
                      >{{ muse.DescLewd }}</span
                    >
                  </div>
                </div>
            ...
            <div v-if="museDataCheck == 3">
              <div class="row q-pa-sm justify-start"></div>
            </div>
            <div
              class="row text-body2 q-pa-xs justify-start items-center"
              v-if="muse.auArray.length != 1"
            >
              <div class="col-sm-2"><b>Variants:</b></div>
              <div class="col-sm-auto">
                <q-btn
                  v-for=" variant in muse.auArray "
                  :key="variant.au"
                  circle
                  flat
                  padding="xs"
              ...
              case "rosa":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.SubDom =
                      "Submissive unless love requires dominance.";
                    this.muse.Desc =
                      "A buntailed, peppy, flexible Unova Pokemon trainer, with a Paldean mother and Galarian the other, who loves to love, and always tries to see the bright side of life and people. Recently come into contact with her distant cousins Nemona and Marnie. ";
                    this.muse.DescLewd =
                      "As expected of a former Team Plasma Grunt, she's eager to please, and quick to treat degradation and harm as 'love bites'.";
                    this.muse.auArray = [
                      {
                        au: "base",
                      ...
                      {
                        au: "rocket",
                        emblem: "/versions/hypnorocket.png",
                        check: false,
                        sfw: "N",
                      },
                      {
                        au: "plasma",
                        emblem: "/versions/Team_Plasma.png",
                        check: false,
                        sfw: "N",
                      },
                      {
                        au: "ua",
                        emblem: "/versions/uagirls.png",
                        check: false,
                        sfw: "Y",
                      },
                    ];
                  ...
                  case "rocket":
                    ...
                    this.muse.Name = "Rosa Whitley";
                    this.muse.SubDom =
                      "Submissive unless mission requires dominance.";
                    this.muse.Desc = "NSFW ONLY - ";
                    this.muse.DescLewd =
                      "A loyal member of Team Rocket's most arousing division. She remains highly peppy, cheerful, and loving, even if her love is Team Rocket. She intends to share her beloved with every cute and hot girl in the world, by whatever means are asked of her, hence her grunt codename.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                  ...
                  case "plasma":
                    ...
                    this.muse.Desc = "NSFW ONLY - ";
                    this.muse.DescLewd =
                      "A permanent long-time member of team Plasma, despite the royalty name she's treated as the lowest of the low, and has lost all notion of ever leaving, genuinely believing the way she's treated is only fair, be it as the team's slut, or the humiliating, arousing punishments for failure. At times she wonders what it would've been to leave, but then she's fucked and used all over and lets go of such silly notions. She is Team Plasma property, nothing else matters.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                  ...
                  case "ua":
                    ...
                    this.muse.Desc =
                      "A quirkless support student with greater focus on metallurgy and the arts, who's been assigned to support student Setsuna Tokage, and does so earnestly with a massive crush on her. But secretly, she's always wanted to try and be somewhat of an actual pro hero. WIth armor and sword. ";
                    this.muse.DescLewd =
                      "She's endlessly fascinated by quirks and outfits, to the point of spending much mental power into how they can be used towards sexy shenanigans. She DOES adore Midnight after all.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "nem":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Desc =
                      "A very hyperactive girl who enjoys Pokemon battling above all else. It has led her to be a Champion-ranked student, though making her ability to relate to others much harder. Has come out of her shell a little through Juliana and Penny, and now her cousin Rosa. ";
                    this.muse.DescLewd =
                      "She treats sex as roughly and dedicated as Pokémon battling. She has fucked and broken many girls she defeats, and intends to do the same for her new friends, longer, harder, tighter. Make them hers for good.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "marn":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.SubDom =
                      "Submissive unless irritated sufficiently. Like a Morpeko.";
                    this.muse.Desc =
                      "A punk-ish girl who seems tough, hiding a truly shy and sweet disposition, with troubles smiling and otherwise expressing herself concisely. She has a legion of fans that cause ruckus, and two cousins that tease her endlessly, both of which she is eternally grateful to. ";
                    this.muse.DescLewd =
                      "When she snaps, she truly embraces that toughness all see, and will use every filthy fantasy on whoever brought it on her. On the other hand, if she breaks, she'll take anything you do to her.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "ida":
                ...
                switch (au) {
                  case "base":
                    this.muse.Title = "Pokemon Trainer?";
                    this.muse.Desc =
                      "A girl thrown into the leadership of the Pearl Clan too soon, she overcompensates with a tough attitude and disposition, hiding a rather soft self. She's been flung forward in time now, to modern day Sinnoh. While happy to explore the vast world in front of her, she can't help but wonder what to do without having to lead. ";
                    this.muse.DescLewd =
                      "Sometimes she too wishes to step down and be just one more person worshiping, as well as forget the breaking of her life's theology..or find a new one.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "iris":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Desc =
                      "A very wild girl who loves dragons, and Pokémon, but is rather clueless and slow to trust and learn when it comes to anything outside of that. After a great journey, she managed to become the Champion of Unova, a title which often swings between her and her claimed sister Rosa. ";
                    this.muse.DescLewd =
                      "It is her earnest hope to be taken by a dragon as a mate and utterly ruined, only existing as a dragon's slave. Or perhaps commanded by one to execute their dominance on other victims.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                  ...
                  case "plasma":
                    ...
                    this.muse.Desc = "NSFW ONLY - ";
                    this.muse.DescLewd =
                      "Kidnapped as part of a recruitment plan, and set up as Rosa's counterpart. Her spirit broke..only towards the favor of Team Plasma. Outside of that, she is brutal and cruel to all who lie in her way, or rather, in Team Plasma's way. And she takes what she wants from her sister grunt, as any proper dragon would do to a princess";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "sere":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Desc =
                      "A fashionable young lady, who's very kind and polite, until she actually snaps. Rather lost in her way, she takes the time while trying to find her future by trying on all kinds of clothes...or tasting all sorts of lips. She IS Kalosian, after all. ";
                    this.muse.DescLewd =
                      "It's not rare to find her only partially dressed, or wearing sexual parodies that barely count as clothes. This too is fashion after all!";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                      ...
                      },
                      {
                        au: "flare",
                        emblem:
                          "/versions/team_flare_by_biochao_dezue6u-pre.png",
                        check: false,
                        sfw: "N",
                      },
                    ];
              ...
              case "brina":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Desc =
                      "A confident woman who's grown a little conceited in her psychic powers, and embraced the cockiness in it, dressing, speaking, and behaving the part of a powerful villain, even when doing good for others. Despite it, shimmers of the sweet kid she couldn't be sometimes shine through. ";
                    this.muse.DescLewd =
                      "She's obsessed with control, and she'll use whatever she's got, be it her looks or her psychic powers, to make sure they go as she wishes. You have no choice in the matter.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "cyn":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Desc =
                      "An adventuring archaeologist who's stumbled upon the title of champion. While not the greatest fan of battling, the title serves her well for clearance into important sites, and her team is prepared to deal with the blow of legendaries' actions. ";
                    this.muse.DescLewd =
                      "She's well aware of the reputation and trauma her prowess does to others, and sometimes she revels in it, playing up her mystery and dominance. Other times? She surprises them with her tenderness. She enjoys either, and the arousing events they lead to.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                  ...
                  case "rocket":
                    ...
                    this.muse.Desc = "NSFW ONLY - ";
                    this.muse.DescLewd =
                      "Offered quite a bit of endorsement for her help in studying mythos (as well as promises that they wouldn't use it for as dangerous goals as Team Galactic), she joined on contract, though contact with their uniforms and culture and the myriad of Sonia's inventions degraded her until she accepted to join in full. She no longer has qualms about whether her knowledge is used for great evil, only how it'll serve team Rocket, her beloved.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "nesa":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Desc =
                      "A model and gym leader from Galar who much like the sea, is calm until battle comes and she becomes the storm. She worries about holding onto her modelling career alongside the gym, but she continues to shine on. She always has time for Sonia though! ";
                    this.muse.DescLewd =
                      "She absolutely adores Sonia and would do anything for her, go as far as she asks. She's taken to masturbate to her at her own pool, hoping the waters hide her own fluids shed from thinking about her closest gal pal.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                  ...
                  case "rocket":
                    ...
                    this.muse.Desc = "NSFW ONLY - ";
                    this.muse.DescLewd =
                      "She entered by Sonia's invitations, and her own secret sensual experiments on her left her suggestible enough to dedicate herself. Team Rocket has helped her greatly in managing her time for gym, modelling, and Rocket missions. And she always has time to assist her Sonia in the lab, grateful she got her here.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "jess":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Desc =
                      "A longtime member of Team Rocket, coming from her own mother being a part of it. While adoring the fashion, the high life of crime, and even the evil plots, the goals of the organization, her position, and the fact she was unable to become a nurse still chafe at her to date, promising one day to rise the ranks and make the organization better anew. ";
                    this.muse.DescLewd =
                      "She's quite confident in her looks, and does her best to wear as little as possible. She doesn't mind people having a look, but rare are those she permits to touch.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                  ...
                  case "rocket":
                    ...
                    this.muse.Desc = "NSFW ONLY - ";
                    this.muse.DescLewd =
                      "A woman who's finally taken center stage in her life and at the top, where she belongs, helping command Team Rocket into a more positive, albeit arousing, direction. Her charm has aided her greatly in both recruitment and reworking Rocket's public perception.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "elesa":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Desc =
                      "An enthusiastic gym leader and supermodel, who's happy to do her best for others and let them shine through, with their own spark. ";
                    this.muse.DescLewd =
                      "She's proudly led many through the pipeline from model to whore, accompanying them all the while in the dark side of fashion and beauty. ";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                  ...
                  case "rocket":
                    ...
                    this.muse.Desc = "NSFW ONLY - ";
                    this.muse.DescLewd =
                      "The actual fashion designer for Team Rocket's new uniforms. She was not originally asked to make them so..arousing, visually or wear-wise. But it went incredibly well, so they accept and ask of her to make them even sluttier.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "lusa":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Spec = "Human";
                    this.muse.SubDom =
                      "Mommy Dommy, you decide if gentle or cruel.";
                    this.muse.Desc =
                      "President of the Aether Foundation, who's too busy and lost in her obsessions to care for her daughter or son. Despite this she is not an unlikeable person, and too many are drawn to her to stop her influence. ";
                    this.muse.DescLewd =
                      "She knows how great she looks and is not afraid to use it to her benefit, as well as simply to relax after a hard day of work...or even to punish and manipulate people into doing her bidding, believing her fully.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                  ...
                  case "aether":
                    ...
                    this.muse.Desc = "NSFW ONLY - ";
                    this.muse.DescLewd =
                      "A deranged woman who's lost herself in the feeling that her beloved Ultra Beast has given her, intent on sharing this gift with the world, starting with her unruly children, who too can become better themselves and truly hers if they accept a Beast too, or their Mother's one.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                  ...
                  case "rocket":
                    ...
                    this.muse.Desc = "NSFW ONLY - ";
                    this.muse.DescLewd =
                      "Joined Team Rocket under false pretenses to undermine them and get out of her way, but was given hypnosis to truly join them..and therapy to acknowledge the issues with her Ultra Beast obsession. After apologies to her daughter (who was already a member), she works hard to make up to her and the world by being very truly kind.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "lumi":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Spec = "???";
                    this.muse.Desc =
                      "A girl who's come from far, far away, many many years ago, to look for her brother. She found him allied with the evil Fatui, and told her to see the world, and so she has, helping every other person who crosses her way, fighting monsters and foes, and dealing with far too much archon bullshit. ";
                    this.muse.DescLewd =
                      "The pressures of being the Traveler, always helping, always going everywhere, tires her out to the point she'd rather just do nothing but masturbate to the unfairly hot women of Teyvat.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                      ...
                      {
                        au: "mirror",
                        emblem: "/versions/Mirror_Maiden_Icon.png",
                        check: false,
                        sfw: "N",
                      },
                    ];
              ...
              case "lisa":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Spec = "Human";
                    this.muse.Desc =
                      "A totally normal librarian who enjoys resting and relaxation, teasing, and a penchant for action and violence when her peace is threatened, almost to the point of sadism. ";
                    this.muse.DescLewd =
                      "Fantasizes of being a mindless slave/drone to greater evils and let herself be used, just for peace of mind.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "yelan":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Spec = "Human";
                    this.muse.Desc =
                      "A woman of many ways, mysterious as she is easygoing. She's an intelligence agent with many affiliations, a tragic tale, and an endless amount of dedication to whatever task is given, if still needing to take the most pragmatical route to conserve energy. ";
                    this.muse.DescLewd =
                      "Depending on her role, her personage changes. The Lady of the Yanshang Teahouse, is an utter tease, a confident goddess people should kneel for, and a very gallant rewarder of those who's gambles go well.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "sam":
                switch (au) {
                  case "base":
                    ...
                    this.muse.Reg = "Space";
                    this.muse.Desc =
                      "A capable yet sensibly muted warrior who unwinds through sex, and carries on her mission to the end, but has trouble emoting, connecting, or sensing. ";
                    this.muse.DescLewd =
                      "She'd happily surrender to an evil alien force if it returned her the ability to feel joy and pleasure and love.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                  ...
                  case "shy":
                    ...
                    this.muse.Desc = "NSFW ONLY - ";
                    this.muse.DescLewd =
                      "A shy gal who makes even less noises than the usual, but shows little shyness in offering herself up for pleasure and flirtation. She seems almost thrilled to be in this position of anonimity. ";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "bow":
                switch (au) {
                  case "base":
                    ...
                    this.muse.SubDom =
                      "Dominant unless trapped into it or flipped by a gorgeous princess";
                    this.muse.Spec = "Koopa/Human";
                    this.muse.Desc =
                      "A newfound boisterous girl with a thirst for cute princesses and world domination. Despite her added human, she's still strong, brash, possessive...and weak to the beauty of princesses. Her dream is all princesses to adore her, and fall for her charms to be hers. ";
                    this.muse.DescLewd =
                      "Though sometimes, she'd like to see what it'd be like if the princesses turned the tables on her.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "pich":
                switch (au) {
                  case "base":
                    ...
                    this.muse.SubDom =
                      "Submissive unless her partner wants a taste";
                    this.muse.Spec = "Toad/Human";
                    this.muse.Reg = "Mushroom Kingdom";
                    this.muse.Desc =
                      "A bubbly princess with great enthusiasm and love for the people of her kingdom. She may be a princess, but she doesn't always stay in the sidelines. Loves to bake, and dress-up, and do all sorts of sports. She either happily enjoys activities with people, or stubbornly refuses.  ";
                    this.muse.DescLewd =
                      "Often, her stubbornness is just in order to invite further pressuring and convincing, as well as playing the part of a good kidnapped princess corrupted. If well convinced, she could assist in corrupting and kidnapping fellow princesses";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                      ...
                      {
                        au: "bow",
                        emblem: "/versions/bow.jpg",
                        check: false,
                        sfw: "N",
                      },
                      {
                        au: "shadow",
                        emblem: "/versions/PMTTYD_Staff_Credits_45.png",
                        check: false,
                        sfw: "Y",
                      },
                    ];
                  ...
                  case "shadow":
                    ...
                    this.muse.SubDom =
                      "Dominant even when amused enough to recieve.";
                    this.muse.Spec = "Toad / Human / Shadow";
                    this.muse.Title = "Shadow Princess";
                    this.muse.Reg = "Rogueport, Mushroom Kingdom";
                    this.muse.Desc =
                      "A dark queen who took over the world many years ago, now possessing Princess Peach to have a second hand at it. The fusion has completed between them, making her agreeable enough to talk, and cordial enough to not destroy it all. ";
                    this.muse.DescLewd =
                      "She's also physical enough to appreciate pleasures of the flesh. She is neither Peach nor the original Shadow queen in full, carrying now all of Peach's lighter traits..and darker sides, including her sexual tastes.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "lina":
                switch (au) {
                  case "base":
                    ...
                    this.muse.SubDom =
                      "Soft Dommy Mommy unless convinced otherwise by great force.";
                    this.muse.Spec = "Human/Goddess";
                    this.muse.Desc =
                      "The mother of all stars, Rosalina is a greatly capable mechanic and mother, traveling space for centuries and seeing her babies turn into planets and galaxies. ";
                    this.muse.DescLewd =
                      "But even a mother and goddess has needs, and space gets very cold and lonely. Hence her frequent visits to the Mushroom Kingdom, or how she sometimes adopts people as their mother yet does lewd activities with them.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                  ...
                  case "bow":
                    ...
                    this.muse.Desc = "NSFW ONLY - ";
                    this.muse.DescLewd =
                      "The former mother of all stars, lowered to a pathetic slut after Bowser destroyed her space station and decided to kidnap her on the way. While less of a frequent visitor than Peachy (given Bow's long time love of the Mushroom Princess) she's no less loyal to her monarch. ";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                  ...
                  case "shy":
                    ...
                    this.muse.Desc = "NSFW ONLY - ";
                    this.muse.DescLewd =
                      "A particularly clingy shy gal, who does her best to stick to you while happily offering her holes. Something is rather ethereal about her, leading to being treated as a rare and lucky find. She's rather a glutton for semen, and the more she drinks the bigger her boobs grow.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "pura":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Desc =
                      "A pre-Calamity science who aged herself to match the hero and princess (though not without error), she strives to work her way up to the wisdom of the ancient sheikah scientists. Her latest look has drawn much attention. ";
                    this.muse.DescLewd =
                      "Ultimately, her eagerness for science is just a tad higher than her ethics, and the only reason she's stuck by the royal family is due to finding a connection with Zelda. Otherwise, she would do anything and anyone if it'd take her tech to greater heights.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                      ...
                      {
                        au: "aoc",
                        emblem: "/versions/HWAoC_Purah_Icon.png",
                        check: false,
                        sfw: "Y",
                      },
                      {
                        au: "yiga",
                        emblem: "/versions/Yiga_Eye.png",
                        check: false,
                        sfw: "N",
                      },
                    ];
                  ...
                  case "aoc":
                    ...
                    this.muse.Title = "Sheikah Scientist";
                    this.muse.Desc =
                      "A very eccentric researcher, older sister to Impa, and working for the royal family of Hyrule. She has found a likeminded soul in Zelda, and does her best to get the tech up to speed to her and the champions' needs, even if sometimes she forgets the world around for her. ";
                    this.muse.DescLewd =
                      "It is a great tragedy that all her efforts will not come to help, and she'll have to wait a century to see the world truly safe AND Zelda well and at ease.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
                  ...
                  case "yiga":
                    ...
                    this.muse.Desc =
                      "A woman who defected from the modern Sheikah for refusing technology, and joined up the Yiga to get them back on track for their original ideology. Despite being ruthless and deeply anti-royalty, under her care the Yiga are much less cruel overall, and more affable to non-Hylian Royalty and Sheikah. ";
                    this.muse.DescLewd =
                      "She has no intent to harm or destroy the princess, and would much rather kidnap her, keep her to herself, and perhaps use the ancient sheikah tech to brainwash her into an obedient puppet for Ganon...and herself";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "tae":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Desc =
                      "An excellent, innovative doctor, who got her reputation ruined by standard medical arrogance of others. She has become a black-alley doctor, and while the things she's accused for tend to be fake, she has a sadistic side to her that would put those accusations to shame. ";
                    this.muse.DescLewd =
                      "Sometimes she takes advantage of patients' unconscious or unwell state to have her way with them, or test even more dangerous, lascivious products on them.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "ann":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Desc =
                      "A fiery girl who works as a model, and goes to school like an average girl. She loves sweets, her girlfriend Shiho, and hates injustice. Feels strongly about how she's perceived by others, be it her womanhood, her sexuality, her race, or her body. And she's perfectly willing to take control and show them all wrong. ";
                    this.muse.DescLewd =
                      "Though at times, she just wants to give in to everyone's perception of her as a bimbo and a slut, and drag her girlfriend down with her.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "sae":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Desc =
                      "A fierce prosecutor who's eternally overworked, undervalued, and ready to strike. She cares deeply for her sister Makoto, but having to care for her as a mother has greatly twisted and strained their relationship. ";
                    this.muse.DescLewd =
                      "She sees the law as a game of chance that she must manipulate in her favor, and intends to place everyone beneath her heel, with her sister to serve her instead.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "shan":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.SubDom =
                      "Sub when approached, Dom when approaching";
                    this.muse.Desc =
                      "A half-genie hero, worthy of said title by her care for others and dedication to helping...even if it is thwarted by annoyances, both villainous and even allied. She rarely holds any ill will regardless, and has helped her foes if need be a good amount of times. ";
                    this.muse.DescLewd =
                      "She is rather aware that she's surrounded by very hot gals, and has given serious thought to fooling around with all of them. Even Risky Boots.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "marin":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Spec = "Human";
                    this.muse.Desc =
                      "A girl who loves what she loves, and isn't ashamed of it. In this case, it's eroges, and cosplay, and her beloved Shizuku-tan (who she has cosplayed, from an eroge). For all her lack of shame in body and tastes, she gets quite flustered at romantic affairs. ";
                    this.muse.DescLewd =
                      "She will shamelessly endorse and enjoy the most degenerate, girl-degrading stuff, having internalized a lot of stuff from her porn.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "yor":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.SubDom =
                      "Dommy Mommy until genuinely cared and adored for";
                    this.muse.Spec = "Human";
                    this.muse.Desc =
                      "The greatest assassin and mother, Yor took up killing to provide for her brother, and now her family. She's terrible at lying and cooking, but she gives her all for who she cares for. There are no more secrets between her and her 'fake' husband. ";
                    this.muse.DescLewd =
                      "He's okay with her sleeping around, so long as she does it in secret. She finds it thrilling, and has fooled around with her coworkers, his coworkers, Eden parents, and even some survivors of her missions.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "stock":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.SubDom =
                      "Dominant unless given the right motivation";
                    this.muse.Spec = "Angel";
                    this.muse.SpecSh = " or Demon";
                    this.muse.Desc =
                      "A relatively professional ghost-destroying angel, Stocking adores sweets and mocks sex, in defiance of her loose and sweet-hating sister. She perfectly combines gothic and sweet lolita styles, just as well as she is both sweetness and seriousness. ";
                    this.muse.DescLewd =
                      "Despite often making fun of Scanty and Kneesocks for their incestual, BDSM-heavy life, she herself is aroused by those things as well. And she will do anything for sweets.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "frie":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Spec = "Elf";
                    this.muse.Desc =
                      "An ancient elf who loves magic, hates demons, and is otherwise a mess. Despite being the world's greatest mage, she has rookie mistakes, and can't resist mimics. She's still getting the hang of human lifespans. ";
                    this.muse.DescLewd =
                      "While elves have a low sex drive, she IS interested in the topic, and having fun with it. Just as magic, she looks for objects and tomes about it, and she's the greatest layer, even if she has some gaps.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
              ...
              case "frie":
                ...
                switch (au) {
                  case "base":
                    ...
                    this.muse.Spec = "Human";
                    this.muse.Desc =
                      "A young girl being taught by Frieren, though half the time she's taking care of her over poor habits. She tries to embody the simple enjoyment of magic by itself, though she's quick to frustrate and anger. ";
                    this.muse.DescLewd =
                      "Unfortunately dragged along commonly to her master's sex-periments, usually having to play nice until it's done. Thankfully used to taking her frustrations out on her in private, in control.";
                    this.muse.auArray = [
                      {
                        au: "base",
                        emblem: "/versions/mirror.jpg",
