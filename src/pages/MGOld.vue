             ...
             <div class="row justify-center">
                <q-table row-key="name" :columns="museColumns" flat bordered dark class="my-sticky-header-table"
                   ...
                   <template v-slot:body-cell-state="props">
                      <q-td :props="props">
                         <q-select v-model="props.row.state" :options="props.row.states" 
                            fill-input input-debounce="0" dark outlined dense 
                            v-if="props.row.states.length > 1"></q-select>
                         <div v-else>
                            {{ props.row.state }}
                         </div>
                      </q-td>
 ...
 export default defineComponent({
    ...
    data: () => ({
       ...
       museColumns: [
          ...
          //{ name: "area", label: "Area", align:"start", field: "sect" },(row) => row.sect, format: (val) => areaReturn(val), 
    ...
    methods: {
       areaReturn(rowvalue) {
          for (var i = 0; i < 6; i++) {
             if (this.museSectLst[i].value == rowvalue) {
                return this.museSectLst[i].label
             }
          }
       },
       dataFill() {
             ...
             case 1:
                switch (char) {
                   case 'rosa':
                      ...
                      switch (au) {
                         ...
                         case 'rocket':
                            ...
                            this.muse.DescLewd = "She intends to share this wonderful team with every cute and hot girl in the world, by whatever means are asked of her, and share the love of Team Rocket with all, hence her grunt codename.";
                            this.muse.auArray = [
                         ...
                         case 'plasma':
                            ...
                            this.muse.DescLewd = "At times she wonders what it would've been to leave, but then she's fucked and used all over and lets go of such silly notions. She is Team Plasma property, nothing else matters.";
                            this.muse.auArray = [
                               { au: 'base', emblem: '/versions/mirror.jpg', check: false },
                               { au: 'rocket', emblem: '/versions/hypnorocket.png', check: false },
                      ...
                      this.muse.kinks.partner = ["Human", "Team Rocket, Team Plasma", "", "Pokemon", ""]
                      this.muse.kinks.relation = ["Member (Self)", "Dog, Cow, Bun (Self)", "Slave (Self)", "Assistant (Self)", "YES", "Mommy/Daughter (Partner/Self), Sister"]
                      this.muse.kinks.clothing = ["", "Pokemon (Dog, Cow, Bun)", "Latex, Nylon, Living", "Evil Team, Maid, School", "YES"]
                      this.muse.kinks.bodyMod = ["YES", "", "YES", "Breasts, Hips"]
                      ...
                      this.muse.kinks.substance = ["Milk", "YES", "Inside", "", ""]
                      this.muse.kinks.bondage = ["Rope, Tentacles, Tape", "YES", "Groping", "", ""]
                      break
                   case 'nem':
                      ...
                      switch (au) {
                         ...
                         case 'rocket':
                            ...
                            this.muse.DescLewd = "Had designs of starting her own evil team of the same occupations and goals, but joined Team Hypno Rocket to not start from scratch.";
                            this.muse.auArray = [
                               { au: 'base', emblem: '/versions/mirror.jpg', check: false },
                               { au: 'rocket', emblem: '/versions/hypnorocket.png', check: true },
                            ]
                      ...
                      this.muse.kinks.partner = ["Human", "", "", "Pokemon", ""]
                      this.muse.kinks.relation = ["", "Dog", "", "YES", "Rivals", ""]
                      this.muse.kinks.clothing = ["", "Pokemon", "Nylon", "School, Team Rocket", ""]
                      this.muse.kinks.bodyMod = ["YES", "", "YES", ""]
                      this.muse.kinks.mindMod = ["", "YES", "", "", ""]
                      this.muse.kinks.transform = ["Partner", "Partner", "", ""]
                   ...
                   case 'marn':
                      ...
                      switch (au) {
                         ...
                         case 'rocket':
                            ...
                            this.muse.DescLewd = "She was more aware than she let on before her hypnosis. She just wanted to have someone else take care of her, and let her emote more, or be more comfortable with her state.";
                            this.muse.auArray = [
                               { au: 'base', emblem: '/versions/mirror.jpg', check: false },
                               { au: 'rocket', emblem: '/versions/hypnorocket.png', check: true },
                            ]
                      ...
                      this.muse.kinks.partner = ["Human", "Team Rocket", "", "Pokemon", ""]
                      this.muse.kinks.relation = ["YES", "YES", "YES", "", "YES", ""]
                      this.muse.kinks.clothing = ["YES", "Pokemon", "Latex, Leather, Nylon, Fishnet", "Team Rocket", "Punk, Pastel"]
                      this.muse.kinks.bodyMod = ["YES", "YES", "YES", "Boobs"]
                      this.muse.kinks.mindMod = ["YES", "YES", "YES", "YES", ""]
                      this.muse.kinks.transform = ["YES", "Partner", "", "YES"]
                      this.muse.kinks.treatment = ["Self", "YES", "YES", "YES", "YES"]
                      this.muse.kinks.consent = ["", "YES", "YES", "YES", "", "YES"]
                      this.muse.kinks.substance = ["", "YES", "Outside", "YES", "Smoking"]
                      this.muse.kinks.bondage = ["Chains, Rope, Tentacle", "YES", "YES", "YES", "YES"]
                      break
                   case 'ida':
                      ...
                      switch (au) {
                         ...
                         case 'rocket':
                            ...
                            this.muse.DescLewd = "Part of her sometimes screams at her about the criminal, sometimes 'evil' actions of the team, but the comfort of worship and mindlessness soothe her too much to dwell on it too long.";
                            this.muse.auArray = [
                               { au: 'base', emblem: '/versions/mirror.jpg', check: false },
                               { au: 'rocket', emblem: '/versions/hypnorocket.png', check: true },
                            ]
                      ...
                      this.muse.kinks.partner = ["Human", "YES", "", "Pokemon", ""]
                      this.muse.kinks.relation = ["Self", "Self", "", "", "", ""]
                      this.muse.kinks.clothing = ["YES", "Pokemon", "Breathable fabrics", "Pearl Clan, Team Rocket", ""]
                      this.muse.kinks.bodyMod = ["", "", "Painting", ""]
                      this.muse.kinks.mindMod = ["", "", "Self", "", "YES"]
                      this.muse.kinks.transform = ["", "", "", "As Partner"]
                      this.muse.kinks.treatment = ["Partner", "", "", "Self", ""]
                      this.muse.kinks.consent = ["", "Self", "", "YES", "YES", "YES"]
                      this.muse.kinks.substance = ["", "YES", "YES", "YES", ""]
                      this.muse.kinks.bondage = ["Rope, Tentacles", "YES", "YES", "YES", "YES"]
                      break
                   case 'iris':
                      ...
                      switch (au) {
                         ...
                         case 'rocket':
                            ...
                            this.muse.DescLewd = "The codename is entirely sarcastic, as those who face her will instead find a dragon, and yet she's very pampered in-team.";
                            this.muse.auArray = [
                               { au: 'base', emblem: '/versions/mirror.jpg', check: false },
                               { au: 'rocket', emblem: '/versions/hypnorocket.png', check: true },
                            ]
                      ...
                      this.muse.kinks.partner = ["Human", "", "", "Pokemon", "Dragon"]
                      this.muse.kinks.relation = ["", "YES", "YES", "", "YES", ""]
                      this.muse.kinks.clothing = ["YES", "Pokemon, Dragon", "", "Evil Team (Rocket, Plasma)", "Princess, Devil"]
                      this.muse.kinks.bodyMod = ["YES", "Nipple Rings", "Scars", "YES"]
                   ...
                   case 'sere':
                      ...
                      switch (au) {
                         ...
                         case 'rocket':
                            ...
                            this.muse.DescLewd = "Said tutoring involved lengthy groping, said training regimes growingly obscene poses and motions, and said workplace training videos were hypnotic. She has forgotten entirely she was ever here undercover, and she is 100% a Team Rocket member now and forever.";
                            this.muse.auArray = [
                               { au: 'base', emblem: '/versions/mirror.jpg', check: false },
                               { au: 'rocket', emblem: '/versions/hypnorocket.png', check: true },
                               { au: 'flare', emblem: '/versions/team_flare_by_biochao_dezue6u-pre.png', check: false },
                         ...
                         case 'flare':
                            ...
                            this.muse.DescLewd = "Some of the outfits were treated to lower personal morals, and increase pleasure based on team Flare approval. She knows now, but doesn't mind, as she asked her current outfits to have ten times the potency of her trial ones.";
                            this.muse.auArray = [
                               { au: 'base', emblem: '/versions/mirror.jpg', check: false },
                               { au: 'rocket', emblem: '/versions/hypnorocket.png', check: false },
                      ...
                      this.muse.kinks.partner = ["Human", "Team Rocket, Team Flare", "", "Pokemon", ""]
                      this.muse.kinks.relation = ["", "", "", "YES", "YES", "Mommy/Daughter: Grace/Self"]
                      this.muse.kinks.clothing = ["", "Pokemon (Fox)", "", "Evil Team", "YES"]
                      this.muse.kinks.bodyMod = ["", "YES", "Sponsorship", "Tits"]
                      this.muse.kinks.mindMod = ["YES", "", "YES", "", ""]
                      this.muse.kinks.transform = ["YES", "YES", "", "YES"]
                      this.muse.kinks.treatment = ["YES", "", "", "YES", ""]
                      this.muse.kinks.consent = ["YES", "", "", "YES", "", "YES"]
                      this.muse.kinks.substance = ["", "", "YES", "", "Smoking"]
                   ...
                   case 'cyn':
                      ...
                      this.muse.kinks.partner = ["Human", "Team Rocket, Team Galactic", "", "Pokemon", ""]
                      this.muse.kinks.relation = ["YES", "YES", "", "Partner", "YES", "Self - Mommy"]
                      this.muse.kinks.clothing = ["YES", "", "Latex, Fur", "Evil Team", "YES"]
                      this.muse.kinks.bodyMod = ["YES", "", "", "Boobs"]
                   ...
                   case 'nesa':
                      ...
                      this.muse.kinks.partner = ["Human", "YES", "", "Pokemon", ""]
                      this.muse.kinks.relation = ["", "", "", "Self", "Sonia", ""]
                      this.muse.kinks.clothing = ["YES", "", "Spandex, Latex", "", "Model"]
                      this.muse.kinks.bodyMod = ["", "Yes", "", "Gigantamax"]
                      this.muse.kinks.mindMod = ["", "Self", "Self", "", ""]
                      this.muse.kinks.transform = ["YES", "YES", "", ""]
                      this.muse.kinks.treatment = ["YES", "", "", "", ""]
                      this.muse.kinks.consent = ["YES", "", "", "", "YES", "YES"]
                      this.muse.kinks.substance = ["", "YES", "Outside", "YES", ""]
                      this.muse.kinks.bondage = ["", "", "YES", "YES", "YES"]
                      break
                   case 'brina':
                      this.muse.Title = "Pokemon";
                      this.muse.Reg = "Kanto";
                      ...
                      switch (au) {
                         ...
                         case 'rocket':
                            ...
                            this.muse.DescLewd = "Some people say the growing sexualization of the female members' outfits is due to her own fetishes, but none dare ever ask. She knows they intend to, though, and she'll never say.";
                            this.muse.auArray = [
                               { au: 'base', emblem: '/versions/mirror.jpg', check: false },
                               { au: 'rocket', emblem: '/versions/hypnorocket.png', check: true },
                            ]
                      ...
                      this.muse.kinks.partner = ["Human", "Team Rocket", "", "Pokemon", ""]
                      this.muse.kinks.relation = ["Self - Worshipped", "Self - Owner", "Self - Owner", "", "", "Self - Mommy"]
                      this.muse.kinks.clothing = ["", "", "Nylon, Latex", "Evil Team", ""]
                      this.muse.kinks.bodyMod = ["", "YES", "As Hers", ""]
                      this.muse.kinks.mindMod = ["Partner", "Partner", "Partner", "Partner", "Partner"]
                      this.muse.kinks.transform = ["Partner", "YES", "", ""]
                      this.muse.kinks.treatment = ["Self", "Partner", "Partner", "Partner", "Partner"]
                      this.muse.kinks.consent = ["", "Partner", "", "YES", "", "YES"]
                      this.muse.kinks.substance = ["", "YES", "Outside", "YES", "YES"]
                      this.muse.kinks.bondage = ["Tentacles, Rope, Whip", "YES", "", "", "YES"]
                      break
                   case 'jess':
                      this.muse.Title = "Pokemon";
                      this.muse.Spec = "Human";
