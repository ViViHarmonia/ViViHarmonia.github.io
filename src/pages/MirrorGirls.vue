			...
			<q-card-section>
				...
				<div class="row flex-center">
					<div class="col-xs-auto q-pa-sm" v-for="sect in sectBtn">
						<div class="row flex-center"><q-btn class="button" :dense="$q.screen.lt.xs" :disabled="section == sect.index"
								@click="section = sect.index">{{ sect.label }}</q-btn>
						</div>
					</div>
				</div>
			</q-card-section>
	...
	<div class="cardHolder flex-center q-pt-sm" v-if="section == 3">
		<q-card :class="{ cardMuse: museSect != 5, cardAllMuse: museSect == 5 }">
			<q-card-section>
				...
				<div class="row flex-center">
					<q-btn v-for="(char, c) in allCharArr" square padding="xs" flat v-show="char.sect == museSect || museSect == 5"
			...
			<q-card-section>
				...
				<div class="row q-pa-sm justify-center">
					<div class="col-xs-3 col-md-3">
						<div class="row flex-center" v-for="(term, t) in knkGlosBtn"><q-btn style="width: 150px" class="button"
								:disabled="kinkCat == term.index" @click="kinkGlossary(term.index)">{{
									term.label }}</q-btn>
						</div>
					</div>
							...
							<div class="row text-body2 q-pa-xs justify-start items-center" v-if="muse.auArray.length != 1">
								...
								<div class="col-xs-auto">
									<q-btn v-for="variant in muse.auArray" :key="variant.au" circle flat padding="xs"
										:disabled="variant.check" @click="museProfileOpen(variant.area, currentMuseCode, variant.au)">
								...
								<q-card class="kinklist">
									<q-card-section>
										<div class="row justify-start">
											<div class="col-xs-6">
												<q-expansion-item v-for="(content, cat) in muse.kinksA" group="kinks" :label="cat" dense>
													<q-card class="kinkitem">
														<q-card-section>
															<div class="row text-body2 justify-start" v-for="(kink, k) in content" v-show="kink != ''">
											...
											<div class="col-xs-6">
												<q-expansion-item v-for="(content, cat) in muse.kinksB" group="kinks" :label="cat" dense>
													<q-card class="kinkitem">
														<q-card-section>
															<div class="row text-body2 justify-start" v-for="(kink, k) in content" v-show="kink != ''">
						...
						case 'stock':
							...
							switch (au) {
								...
								case 'venom':
									...
									this.muse.SpecSh = " Demon/Symbiote";
